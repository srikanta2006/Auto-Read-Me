...
- **Logic Flow**: Use a GitHub-compatible **Mermaid.js** flowchart (\`graph TD\`).
-Avoid parentheses, commas, colons, or special characters in node labels.
Keep node labels short and alphanumeric only.
